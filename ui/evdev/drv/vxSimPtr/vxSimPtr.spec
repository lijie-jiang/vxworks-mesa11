...
Name: evdev_vxsimptr
Summary: VxWorks simulator pointer driver
Version: 1.0.1.1
Group: ui/evdev/drv/vxsim
Prefix: /vxworks-7/pkgs/ui/evdev/drv/vxSimPtr
VXDest: /vxworks-7/pkgs/ui/$evdev_ns_container/drv/vxSimPtr
...
%description
VxWorks simulator pointer driver 
