/* saxTutorial3.c - expat sax parser tutorial */
...
/*
DESCRIPTION
This tutorial demonstrates how to extract character data (CDATA) from an XML
document. This tutorial requires the following components: XML SAX parser.  
...
/************************************************
 *    Set the handler for the character data    *
 ************************************************/
    XML_SetCharacterDataHandler(parser, cdataHandler3);
 ...
 *    Start program here    * 
 ****************************/
void run_saxTutorial3()
    {
    char *xmlFile  = "saxTutorial.xml";

    xmlSaxParseFile3(xmlFile);
    }
