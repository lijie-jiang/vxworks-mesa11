...
27mar15,rpc  Static analysis fixes (US50633) missing returns.
22jan15,qsn  Port I915 driver to VxWorks 7 (US50702)
*/

#if defined(__vxworks)
#define IS_ENABLED(flag) 0
#include <vxoal/krnl/types.h> /*for __iomem */
#include <vxoal/krnl/module.h> /* for MODULE_AUTHOR */
#include <vxoal/krnl/pci.h> /* for pci_dev */
#include <vxoal/krnl/mm.h> /* for page */
#include <vxoal/krnl/scatterlist.h> /* for scatterlist */
#include <vxoal/krnl/io.h> /* for readl, writel */
#include <vxoal/krnl/time.h> /* for msecs_to_jiffies, time_after */
#include <drm/drmP.h>
#else
