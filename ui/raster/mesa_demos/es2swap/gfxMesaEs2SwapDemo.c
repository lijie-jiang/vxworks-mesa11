/* gfxMesaEs2SwapDemo.c - OpenGL ES2 Swap Demo */
...
This example program provides the OpenGL ES2 swap program.

The program is started by executing the application's entry point,
gfxMesaEs2SwapDemoStart; as follows:

-> gfxMesaEs2SwapDemoStart(0, 0)
...
/*******************************************************************************
 *
 * gfxMesaEs2SwapDemo - start of the program
 *
...
int gfxMesaEs2SwapDemo
    ...
    {
    return gfxEs2SwapDemo(device, runTime, eglDriver, interval);
    }

#if defined(_WRS_KERNEL)
/*******************************************************************************
 *
 * gfxMesaEs2SwapDemoStart - start of the program in kernel mode
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxMesaEs2SwapDemoRtp
 *
 */
void gfxMesaEs2SwapDemoStart
    (
    unsigned int device,
    unsigned int runTime,
    unsigned int eglDriver,
...
void gfxMesaDriEs2SwapDemoStart
    ...
    {
    gfxMesaEs2SwapDemoStart (device, runTime, GFX_USE_EGL_DRI, interval);
    }
#endif
/*******************************************************************************
 *
 * gfxMesaEs2SwapDemoRtp - start of the program for invoking RTP
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxMesaEs2SwapDemoStart
 *
 */
static void gfxMesaEs2SwapDemoRtp0
    (
    const char *rtpStr,
    unsigned int device,
    unsigned int runTime,
...
void gfxMesaEs2SwapDemoRtp
    ...
    {
    gfxMesaEs2SwapDemoRtp0 ("gfxMesaEs2SwapDemo.vxe", device, runTime, eglDriver, interval);
    }

void gfxMesaEs2SwapSoDemoRtp
    (
    unsigned int device,
    unsigned int runTime,
    unsigned int eglDriver,
    ...
    {
    gfxMesaEs2SwapDemoRtp0 ("gfxMesaEs2SwapSoDemo.vxe", device, runTime, eglDriver, interval);
    }

#if defined(GFX_USE_GBM)
void gfxMesaDriEs2SwapDemoRtp
    (
    unsigned int device,
    unsigned int runTime,
    unsigned int interval
    ...
    {
    gfxMesaEs2SwapDemoRtp (device, runTime, GFX_USE_EGL_DRI, interval);
    }

void gfxMesaDriEs2SwapSoDemoRtp
    (
    unsigned int device,
    unsigned int runTime,
    unsigned int interval
    ...
    {
    gfxMesaEs2SwapSoDemoRtp (device, runTime, GFX_USE_EGL_DRI, interval);
    }
#endif
#else
...
int main
    ...
    return (gfxMesaEs2SwapDemo (device, runTime, eglDriver, interval));
    }
#endif
