...
/*******************************************************************************
 *
 * gfxMesaMainDemo - start of the program
 *
...
/*******************************************************************************
 *
 * gfxMesaMainDemoStart - start of the program in kernel mode
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxMesaMainDemoRtp
 *
 */
void gfxMesaMainDemoStart
    (
    unsigned int device,
    unsigned int count,
    unsigned int eglDriver
...
void gfxMesaDriMainDemoStart
    ...
    {
    gfxMesaMainDemoStart (device, count, GFX_USE_EGL_DRI);
    }
#endif
/*******************************************************************************
 *
 * gfxMesaMainDemoRtp - start of the program for invoking RTP
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxMesaMainDemoStart
 *
 */
static void gfxMesaMainDemoRtp0
    (
    const char *rtpStr,
    unsigned int device,
    unsigned int count,
...
void gfxMesaMainDemoRtp
    ...
    {
    gfxMesaMainDemoRtp0 ("gfxMesaMainDemo.vxe", device, count, eglDriver);
    }

void gfxMesaMainSoDemoRtp
    (
    unsigned int device,
    unsigned int count,
    unsigned int eglDriver
    ...
    {
    gfxMesaMainDemoRtp0 ("gfxMesaMainSoDemo.vxe", device, count, eglDriver);
    }

#if defined(GFX_USE_GBM)
void gfxMesaDriMainDemoRtp
    (
    unsigned int device,
    unsigned int count
    )
    {
    gfxMesaMainDemoRtp (device, count, GFX_USE_EGL_DRI);
    }

void gfxMesaDriMainSoDemoRtp
    (
    unsigned int device,
    unsigned int count
    )
    {
    gfxMesaMainSoDemoRtp (device, count, GFX_USE_EGL_DRI);
    }
#endif
#else
#if defined(_VG)||(_MESA)
...
#endif
    return (gfxMesaMainDemo (device, count, eglDriver, runCl));
    }
#endif
