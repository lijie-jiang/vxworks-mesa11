...
04nov14,yat  Add simple demo for OpenCL (US48896)
...
#else
#if defined(_GL)
#define gfxMesaSwapDemo gfxSwapDemo
#define gfxMesaGearDemo gfxGearDemo
#endif
#if defined(_ES1)
#define gfxMesaEs1GearDemo gfxEs1GearDemo
#endif
#if defined(_ES2)
#define gfxMesaEs2SwapDemo gfxEs2SwapDemo
#define gfxMesaEs2GearDemo gfxEs2GearDemo
#define gfxMesaEs2LogoDemo gfxEs2LogoDemo
#endif
#if defined(_ES3)
#define gfxMesaEs3SwapDemo gfxEs3SwapDemo
#endif
#if defined(_VG)
#define gfxMesaVgSwapDemo gfxVgSwapDemo
#if defined(_VG_IMAGE)
#define gfxRasterVgFlowDemo gfxVgFlowDemo
#define gfxRasterVgImageDemo gfxVgImageDemo
#endif
#define gfxMesaVgPatternDemo gfxVgPatternDemo
#define gfxMesaVgScrollDemo gfxVgScrollDemo
#define gfxMesaVgSubwayDemo gfxVgSubwayDemo
#endif
#if defined(_CL)
#define gfxMesaClSimpleDemo gfxClSimpleDemo
#endif
#endif

/*******************************************************************************
 *
 * gfxMesaEsMainDemo - start of the program
 *
...
/*******************************************************************************
 *
 * gfxMesaEsMainDemoStart - start of the program in kernel mode
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxMesaEsMainDemoRtp
 *
 */
void gfxMesaEsMainDemoStart
    (
    unsigned int device,
    unsigned int count,
    unsigned int eglDriver
...
void gfxMesaDriEsMainDemoStart
    ...
    {
    gfxMesaEsMainDemoStart (device, count, GFX_USE_EGL_DRI);
    }
#endif
/*******************************************************************************
 *
 * gfxMesaEsMainDemoRtp - start of the program for invoking RTP
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxMesaEsMainDemoStart
 *
 */
static void gfxMesaEsMainDemoRtp0
    (
    const char *rtpStr,
    unsigned int device,
    unsigned int count,
...
void gfxMesaEsMainDemoRtp
    ...
    {
    gfxMesaEsMainDemoRtp0 ("gfxMesaEsMainDemo.vxe", device, count, eglDriver);
    }

void gfxMesaEsMainSoDemoRtp
    (
    unsigned int device,
    unsigned int count,
    unsigned int eglDriver
    ...
    {
    gfxMesaEsMainDemoRtp0 ("gfxMesaEsMainSoDemo.vxe", device, count, eglDriver);
    }

#if defined(GFX_USE_GBM)
void gfxMesaDriEsMainDemoRtp
    (
    unsigned int device,
    unsigned int count
    )
    {
    gfxMesaEsMainDemoRtp (device, count, GFX_USE_EGL_DRI);
    }

void gfxMesaDriEsMainSoDemoRtp
    (
    unsigned int device,
    unsigned int count
    )
    {
    gfxMesaEsMainSoDemoRtp (device, count, GFX_USE_EGL_DRI);
    }
#endif
#else
#if defined(_VG)||(_MESA)
...
#endif
    return (gfxMesaEsMainDemo (device, count, eglDriver, runCl));
    }
#endif
