...
/*******************************************************************************
 *
 * gfxMesaMainTest - start of the program
 *
...
/*******************************************************************************
 *
 * gfxMesaMainTestStart - start of the program in kernel mode
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxMesaMainTestRtp
 *
 */
void gfxMesaMainTestStart
    (
    unsigned int device,
    unsigned int count,
    unsigned int eglDriver
    ...
    (void)taskSpawn ("tMain", 220, VX_FP_TASK, DEFAULT_STACK_SIZE,
                     (FUNCPTR) gfxMesaMainTest,
                     device, count, eglDriver, runCl, 0, 0, 0, 0, 0, 0 );
    }
#if defined(GFX_USE_GBM)
void gfxMesaDriMainTestStart
    (
    unsigned int device,
    unsigned int count
    )
    {
    gfxMesaMainTestStart (device, count, GFX_USE_EGL_DRI);
    }
#endif
/*******************************************************************************
 *
 * gfxMesaMainTestRtp - start of the program for invoking RTP
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxMesaMainTestStart
 *
 */
static void gfxMesaMainTestRtp0
    (
    const char *rtpStr,
    unsigned int device,
    unsigned int count,
...
void gfxMesaMainTestRtp
    ...
    {
    gfxMesaMainTestRtp0 ("gfxMesaMainTest.vxe", device, count, eglDriver);
    }

void gfxMesaMainSoTestRtp
    (
    unsigned int device,
    unsigned int count,
    unsigned int eglDriver
    ...
    {
    gfxMesaMainTestRtp0 ("gfxMesaMainSoTest.vxe", device, count, eglDriver);
    }

#if defined(GFX_USE_GBM)
void gfxMesaDriMainTestRtp
    (
    unsigned int device,
    unsigned int count
    )
    {
    gfxMesaMainTestRtp (device, count, GFX_USE_EGL_DRI);
    }

void gfxMesaDriMainSoTestRtp
    (
    unsigned int device,
    unsigned int count
    )
    {
    gfxMesaMainSoTestRtp (device, count, GFX_USE_EGL_DRI);
    }
#endif
#else
#if defined(_VG)||(_MESA)
...
#endif
    return (gfxMesaMainTest (device, count, eglDriver, runCl));
    }
#endif
