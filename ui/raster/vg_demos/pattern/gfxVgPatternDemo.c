/* gfxVgPatternDemo.c - Vector Graphics Tiling Demo */
...
gfxVgPatternDemoStart; as follows:

-> gfxVgPatternDemoStart(0,0)
...
/*******************************************************************************
 *
 * gfxRasterVgPatternDemo - start of the program
 *
 ...
 *
 */
int gfxRasterVgPatternDemo
    (
    unsigned int device,
    unsigned int runTime
    )
    {
    return gfxVgPatternDemo (device, runTime);
    }

#if defined(_WRS_KERNEL)
/*******************************************************************************
 *
 * gfxVgPatternDemoStart - start of the program in kernel mode
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxVgPatternDemoRtp
 *
 */
void gfxVgPatternDemoStart
    (
    unsigned int device,
    unsigned int runTime
    )
    {
    (void)taskSpawn ("tPattern", 100, VX_FP_TASK, 0x10000,
                     (FUNCPTR) gfxRasterVgPatternDemo,
                     device, runTime, 0, 0, 0, 0, 0, 0, 0, 0 );
    }

/*******************************************************************************
 *
 * gfxVgPatternDemoRtp - start of the program for invoking RTP
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxVgPatternDemoStart
 *
 */
static void gfxVgPatternDemoRtp0
    (
    const char *rtpStr,
    unsigned int device,
    unsigned int runTime
...
void gfxVgPatternDemoRtp
    (
    unsigned int device,
    unsigned int runTime
    )
    {
    gfxVgPatternDemoRtp0 ("gfxVgPatternDemo.vxe", device, runTime);
    }

void gfxVgPatternSoDemoRtp
    (
    unsigned int device,
    unsigned int runTime
    )
    {
    gfxVgPatternDemoRtp0 ("gfxVgPatternSoDemo.vxe", device, runTime);
    }
#else
...
int main
    ...
    return (gfxRasterVgPatternDemo (device, runTime));
    }
#endif
