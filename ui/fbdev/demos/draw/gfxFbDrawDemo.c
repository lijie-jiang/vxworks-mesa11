/* gfxFbDrawDemo.c - Frame buffer draw demo */
...
gfxFbDrawDemoStart; as follows:

-> gfxFbDrawDemoStart(0, 0)
...
/*******************************************************************************
 *
 * gfxFbDrawDemoStart - start of the program in kernel mode
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxFbDrawDemoRtp
 *
 */
void gfxFbDrawDemoStart
    (
    unsigned int device,
    ...
    (void)taskSpawn ("tDraw", 100, VX_FP_TASK, 0x10000,
                     (FUNCPTR) gfxFbDrawDemo,
                     device, runTime, drawX0, drawY0, drawX1, drawY1, 0, 0, 0, 0 );
    }

/*******************************************************************************
 *
 * gfxFbDrawDemoRtp - start of the program for invoking RTP
 *
 ...
 * ERRNO: N/A
 *
 * SEE ALSO: gfxFbDrawDemoStart
 *
 */
static void gfxFbDrawDemoRtp0
    (
    const char *rtpStr,
    unsigned int device,
    unsigned int runTime,
...
void gfxFbDrawDemoRtp
    ...
    {
    gfxFbDrawDemoRtp0 ("gfxFbDrawDemo.vxe", device, runTime, drawX0, drawY0, drawX1, drawY1);
    }
#else
/*******************************************************************************
 *
...
int main
    ...
    return (gfxFbDrawDemo (device, runTime, drawX0, drawY0, drawX1, drawY1));
    }
#endif
