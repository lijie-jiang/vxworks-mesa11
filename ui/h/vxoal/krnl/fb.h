...
#include <uapi/fb.h> /* for fb_info */
#include <vxoal/krnl/types.h> /* for u32 */
#include <vxoal/krnl/system.h> /* for notifier_block */
#include <vxoal/krnl/device.h> /* for device, device_node, file */
#include <vxoal/krnl/mutex.h> /* for mutex */
#include <vxoal/krnl/list.h> /* for list_head */
#include <vxoal/krnl/mm.h> /* for vm_area_struct */
...
#define unregister_framebuffer(fb_info)
#define fb_set_suspend(info, state)
#else
...
#if defined(__vxworks)
#define fb_alloc_cmap(cmap, len, transp) (0)
#define fb_alloc_cmap_gfp(cmap, len, transp, flags) (0)
#define fb_dealloc_cmap(cmap)
#else
...
/* Do not implement VGA switcheroo */
#define vga_switcheroo_register_client(p1, p2, p3) (0)
#define vga_switcheroo_unregister_client(p1)
#define vga_switcheroo_process_delayed_switch()
#define vga_switcheroo_client_fb_set(p1, p2)

/* Do not implement ACPI video register */
#define acpi_video_register()
#define acpi_video_unregister()

/* Do not implement console */
#define console_lock()
